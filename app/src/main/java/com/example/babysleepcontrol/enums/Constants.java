...
public  class Constants {
    public static  SimpleDateFormat DAY_TIME_FORMAT = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss", Locale.getDefault());
    public static  SimpleDateFormat DAY_YEAR_ONLY_FORMAT = new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault());
    public static  SimpleDateFormat YEAR_ONLY_FORMAT = new SimpleDateFormat("yyyy", Locale.getDefault());
